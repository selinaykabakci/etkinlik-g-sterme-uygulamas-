<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kayıt.aspx.cs" Inherits="Ip_proje.kayıt" %>
...
<asp:Button ID="btn_Login" runat="server" Text="Kayıt Ol" CssClass="btn btn-block btn-primary" OnClick="btn_Login_Click" />
...
<div class="social-login">
    <asp:Button ID="btn_home" runat="server" Text="Ana Sayfaya Dön" OnClientClick="return confirmLeave();" CssClass="btn btn-primary btn-block buton" OnClick="btn_home_Click" />
</div>
</form>
</div>
</div>
